...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.${rootArtifactId}.repository.redis.utils;
...
//     * @return
//     */
//    public void scanAndDel(String keyPrefix) {
...
//            }
//        } catch (Exception e) {
////            LoggerUtil.error("【redis scanAndDel】", e);
//        }
//    }
//    // ============================String=============================
//
...
//                Boolean testFlag = redisTemplate.opsForValue().setIfAbsent(key, value, expireTime, TimeUnit.SECONDS);
//                if (testFlag) {
//                    return testFlag;
//                }
//                try {
