...
public class XxlJobConfig {
    ...
    @Value("${symbol_dollar}{xxl.job.access-token}")
    private String accessToken;

    @Value("${symbol_dollar}{xxl.job.executor.app-name}")
    ...
    @Value("${symbol_dollar}{xxl.job.executor.log-path}")
    private String logPath;

    @Value("${symbol_dollar}{xxl.job.executor.log-retention-days}")
